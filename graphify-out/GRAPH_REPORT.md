# Graph Report - epoch-widget  (2026-09-17)

## Corpus Check
- 212 files · ~111,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1205 nodes · 2179 edges · 102 communities (78 shown, 22 thin omitted)
...
- `UseMidenBridgeIntentOptions` --references--> `CrossChainIntentParams`  [EXTRACTED]
  demo/src/miden/hooks/useMidenBridgeIntent.ts → demo/src/miden/types/miden.ts
...
Cohesion: 0.20
Nodes (22): PaySwapIntentWidgetProps, PaySwapVariantSpec, DestinationSelection, PaySwapEngine, PLACEHOLDER_INTENT, usePaySwapEngine(), PaySwapMiden, PaySwapMidenDest (+14 more)

### Community 1 - "src/index.ts"
Cohesion: 0.07
Nodes (41): @epoch-protocol/epoch-flows-sdk, EarnIntentWidget(), PoweredIcon, IntentProgressProps, Modal(), ModalProps, PaySwapMainViewProps, PayIntentSummary() (+33 more)

### Community 2 - "PaySwapIntentWidget.tsx"
Cohesion: 0.06
Nodes (35): EarnCtaButton(), EarnCtaButtonProps, RetryIcon, NetworkBadge(), NetworkToggle(), NetworkToggleProps, segmentClasses(), CTA_TONE_CLASSES (+27 more)
...
Cohesion: 0.14
Nodes (16): ALL_CHAINS, ALL_LENDERS, DEFAULT_CHAIN_IDS, FAMILY_DISPLAY, FAMILY_DOT, familyOf(), KEEP_UPPER_LENDER_SEG, MarketPickerPage() (+8 more)

### Community 6 - "useLatestRef"
Cohesion: 0.29
Nodes (7): useLatestRef(), useOnOpen(), toBigIntOrNull(), usePaySwapCallbacks(), IntentFlowStatus, UseIntentFlowParams, UseIntentFlowReturn

### Community 7 - "MidenBridgePanel.tsx"
Cohesion: 0.22
Nodes (14): MidenExecutionStatus(), MidenExecutionStatusProps, DEFAULT_SEPOLIA_CHAIN_ID_STR, useIntentFlowStatus(), EVM_EXPLORERS, explorerTxUrl(), MIDEN_CHAIN_ID, MIDENSCAN_BASE (+6 more)

### Community 8 - "cn.ts"
Cohesion: 0.12
Nodes (19): Props, Props, TokenChainPill(), Card(), CardTone, Props, TONE_CLASSES, Pill() (+11 more)
...
Cohesion: 0.14
Nodes (15): Avatar(), AvatarProps, ArrowDownIcon, ArrowDownUpIcon, WalletIcon, CardData, IntentSummary(), IntentSummaryProps (+7 more)
...
Cohesion: 0.22
Nodes (14): getMidenFaucetDecimals(), MIDEN_FAUCET_DECIMALS, toMapKey(), useEpochIntent(), buildCrossChainIntent(), buildEpochTaskDataParams(), CrossChainQuote, getCrossChainQuote() (+6 more)

### Community 13 - "EarnIntentWidget.tsx"
Cohesion: 0.10
Nodes (25): Banner(), BannerProps, BannerVariant, VARIANT_CLASSES, EarnMainView(), EarnMainViewProps, EarnWithdrawDetailView(), EarnWithdrawDetailViewProps (+17 more)

### Community 14 - "use-earn-intent-flow.ts"
Cohesion: 0.19
Nodes (18): EARN_MIDEN_EXTRA_FIELDS, normalizeMidenId(), buildSwapLegTaskInput(), createEarnIntentSdk(), EarnIntentFlowStatus, earnProtocolName(), EarnQuote, EarnQuoteInput (+10 more)

### Community 15 - "package.json"
Cohesion: 0.07
Nodes (29): bugs, description, files, homepage, @epoch-protocol/epoch-commons-sdk, @epoch-protocol/epoch-intents-sdk, react, react-dom (+21 more)
...
Cohesion: 0.16
Nodes (11): lucide-react, GaslessEnableButton(), GaslessEnableButtonProps, ChevronRightIcon, HistoryToolbarIcon, IconCompatProps, LockIcon, SettingsToolbarIcon (+3 more)
...
### Community 19 - "cn"
Cohesion: 0.10
Nodes (22): ChainSelector(), ChainSelectorProps, CSS_VARS_TO_MIRROR, Dropdown(), DropdownOption, DropdownProps, GaslessToggle(), GaslessToggleProps (+14 more)
...
### Community 21 - "TokenSelector.tsx"
Cohesion: 0.24
Nodes (8): CHAIN_DOT, chainDotColor(), CloseIcon, MarketSelectButton(), ChainChip(), ChainChipProps, TokenSelector(), TokenSelectorProps

### Community 22 - "useMidenWalletAdapter.ts"
Cohesion: 0.21
Nodes (10): MidenBridgeFields(), MidenBridgeFieldsProps, OutputToken, MidenWalletAsset, NormalizedMidenAccountId, resolveAccountId(), stripMidenIdDecorators(), useMidenWalletAdapter() (+2 more)

### Community 23 - "EarnSurface.tsx"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (11): DOT_SIZE, dotStyle(), FilterDropdown(), FilterOption, Props, renderItem(), TRIGGER_SIZE, POSITIONS_LENDER_OPTIONS (+3 more)
...
Cohesion: 0.19
Nodes (10): AppShell(), NETWORK_TABS, Props, Badge(), toneClass, Row(), Props, ScenarioCard() (+2 more)
...
Cohesion: 0.27
Nodes (10): ASSOCIATED_TOKEN_PROGRAM_ID, associatedTokenAddress(), bindingHashToBytes(), buildOpenEscrowTransaction(), configPda(), escrowPda(), OPEN_ESCROW_DISCRIMINATOR, TOKEN_PROGRAM_ID (+2 more)

### Community 30 - "WithdrawDetailPanel.tsx"
Cohesion: 0.12
Nodes (15): PositionRow(), Props, SmartWithdrawDestination(), SmartWithdrawDestinationProps, SmartWithdrawToggle(), SmartWithdrawToggleProps, FRACTIONS, WithdrawAmountCard() (+7 more)
...
Cohesion: 0.15
Nodes (18): config, midenConfig, queryClient, isNonceLike(), MidenBridgeIntent, readNonce(), useMidenBridgeIntent(), UseMidenBridgeIntentOptions (+10 more)

### Community 33 - "earn/miden.ts"
Cohesion: 0.24
Nodes (12): bech32HrpExpand(), bech32Polymod(), decodeMidenBech32(), getMidenGraphTokens(), isDefaultMidenFaucet(), midenFaucetKey(), MidenGraphToken, EarnMiden (+4 more)
...
### Community 42 - "SwapSurface.tsx"
Cohesion: 0.24
Nodes (11): DemoNetwork, ScenarioProps, SWAP_SCENARIOS, SWAP_TESTNET_SCENARIOS, Props, Props, applyEdits(), editsFromScenario() (+3 more)

### Community 43 - "MidenQuoteCard.tsx"
Cohesion: 0.67
Nodes (3): MidenQuoteCard(), MidenQuoteCardProps, formatQuoteTokenIn()

### Community 45 - "PaySurface.tsx"
Cohesion: 0.23
Nodes (9): EditableField(), Props, SectionLabel(), applyEdits(), Edits, editsFromScenario(), FlatEdits, IntentEdits (+1 more)

### Community 46 - "use-earn-engine.ts"
Cohesion: 0.11
Nodes (22): TokenWithChain, useUserPositions(), exceedsBalance(), positionWithdrawableRaw(), EarnCtaAction, EarnCtaState, isEarnCtaEnabled(), resolveEarnCta() (+14 more)
...
### Community 71 - "MarketRowCard.tsx"
Cohesion: 0.21
Nodes (10): FAMILY_LABELS, fmtUsd(), LENDER_DOT, MarketRowCard(), Props, TrendingUpIcon, ACCENT_PALETTE, colorFor() (+2 more)
...
### Community 100 - "scenarios.ts"
Cohesion: 0.22
Nodes (7): BASE_SEPOLIA_USDC, OP_SEPOLIA_USDC, PAY_SCENARIOS, PAY_TESTNET_SCENARIOS, SHARED_CTA_LABELS, SWAP_INITIAL_INTENT, SWAP_TESTNET_INITIAL_INTENT

### Community 101 - "useDemoSolanaAdapter.ts"
Cohesion: 0.38
Nodes (6): describeSolanaError(), getPhantomProvider(), PhantomProvider, useDemoSolanaAdapter(), Window, @solana/web3.js
...
- **Why does `@epoch-protocol/epoch-flows-sdk` connect `src/index.ts` to `api.ts`, `MarketPickerPage.tsx`, `useLatestRef`, `SwapIntentSummary.tsx`, `use-earn-engine.ts`, `package.json`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `src/index.ts`, `PaySwapIntentWidget.tsx`, `MarketRowCard.tsx`, `cn.ts`, `SwapIntentSummary.tsx`, `EarnIntentWidget.tsx`, `Icons.tsx`, `TokenSelector.tsx`, `WithdrawPanel.tsx`, `WithdrawDetailPanel.tsx`?**
